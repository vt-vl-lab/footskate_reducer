...
if __name__ == '__main__':
    root = '/home/ylzou/research/WACV2020/motion_reconstruct/openpose_output/example'
    dump = os.path.join('/home/ylzou/research/WACV2020/ground_detector/data', root.split('/')[-1])
    ...
    for folder in folders:
        ...
        save_name = os.path.join(dump, folder.split('/')[-1])
